...
function weatherDetails(info){
    ...
    const {feels_like, humidity, temp} = info.main;
        ...
        if(id == 800){
            wIcon.src="C:\Users\Piyushkumar I Desai\Desktop\bharatt2\clear.svg"
        } else if (id >= 200 && id <=232){
            wIcon.src="C:\Users\Piyushkumar I Desai\Desktop\bharatt2\strom.svg"
        } else if (id >= 600 && id <= 622){
            wIcon.src="C:\Users\Piyushkumar I Desai\Desktop\bharatt2\snowy.svg"
        } else if (id >= 701 && id <=781){
            wIcon.src="C:\Users\Piyushkumar I Desai\Desktop\bharatt2\haze.svg"
        } else if (id >= 801 && id <=804){
            wIcon.src="C:\Users\Piyushkumar I Desai\Desktop\bharatt2\cloudy.svg"
        }  else if ((id >= 300 && id <= 321) || (id >= 500 && id <= 531)){
            wIcon.src="C:\Users\Piyushkumar I Desai\Desktop\bharatt2\rainy.svg"
        } 
